...
class okofen extends eqLogic {
	...
	private $_Temperature_OkoLabel = 'CAPPL:FA[0].L_kesseltemperatur';
	...
	private $_OkoValues = array (
	    array( 'name' => 'Status',            'okoId' => 'CAPPL:FA[0].L_kesselstatus'              , 'subType' => 'string'  ),
	    ...
	    array( 'name' => 'Temp Amb',          'okoId' => 'CAPPL:LOCAL.L_hk[0].raumtemp_ist'        , 'subType' => 'numeric'),
            ...
            array( 'name' => 'Chf1 Pompe',        'okoId' => 'CAPPL:LOCAL.L_hk[0].pumpe'               , 'subType' => 'binary' ),
            array( 'name' => 'Chf1 Mode',         'okoId' => 'CAPPL:LOCAL.hk[0].betriebsart[1]'        , 'subType' => 'string'  ),
	    array( 'name' => 'Chf2 Pompe',        'okoId' => 'CAPPL:LOCAL.L_hk[1].pumpe'               , 'subType' => 'binary' ),
            array( 'name' => 'Chf2 Mode',         'okoId' => 'CAPPL:LOCAL.hk[1].betriebsart[1]'        , 'subType' => 'string'  ),
   	    array( 'name' => 'Temp Solair',       'okoId' => 'CAPPL:LOCAL.L_sk[0].kollektortemp_ist'   , 'subType' => 'numeric'),
   	    array( 'name' => 'Pompe Solair',      'okoId' => 'CAPPL:LOCAL.L_sk[0].pumpe'               , 'subType' => 'numeric'),
...
/*
      ...
      if (!is_object($cmdlogic)) {
        ...
        $cmdlogic->setEqLogic_id($this->getId());
        $cmdlogic->setLogicalId($this->_Temperature_OkoLabel);
        $cmdlogic->setConfiguration('OkofenId',$this->_Temperature_OkoLabel);
...
///----MEs fonctions
   ...
   public function getDataPellematic(){
	...
	$cmds = okofenCmd::byEqLogicId($this->getId());
	 ...
	 $getDataUrl = 'http://'.$ip.'/index.cgi?action=get&attr=1';
...
/*
    	...
    	$temp = $this->_parsedData[$this->_Temperature_OkoLabel];
    	if($temp) { 	 
        	$changed = $this->checkAndUpdateCmd($this->_Temperature_OkoLabel, $temp) || $changed;
    	} 
